...
export default function Contact() {
  ...
  const handleEmailClick = () => {
    ...
    const body = encodeURIComponent(
      "Please describe your issue here (Include Phone Number/Booking ID)...",
    );
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 space-y-4">
          ...
          <p className="max-w-xl text-zinc-500 font-light leading-relaxed">
            Initialize a direct connection with our core team. We provide
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-zinc-500 leading-relaxed max-w-sm">
                  Click the card to open your mail app. If it doesn't open, use
                  the copy button and paste into Gmail.
                </p>
              </div>
            </div>
            ...
            <div className="pt-8 flex items-center gap-4 px-4 opacity-40 grayscale hover:grayscale-0 transition-all cursor-crosshair">
              ...
              <span className="text-[10px] font-mono uppercase tracking-[0.2em]">
                Secure_Server_Transmission_Active
              </span>
            </div>
          </div>
          ...
          <div className="space-y-8 bg-white/[0.01] border border-white/5 p-10 rounded-[3rem]">
            <div className="space-y-4 border-t border-white/5 pt-4">
              ...
              <div className="grid gap-4">
                <div className="flex gap-4 items-start p-4 bg-white/[0.02] rounded-2xl border border-white/5">
                  ...
                  <div>
                    <h5 className="text-xs font-black uppercase text-zinc-300">
                      Refund_Protocols
                    </h5>
                    <p className="text-[11px] text-zinc-500 font-mono mt-1">
                      Issues regarding failed transactions or cancellations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start p-4 bg-white/[0.02] rounded-2xl border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-zinc-500 font-mono mt-1">
                      General help or studio profile management.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-violet-500/5 border border-violet-500/10 p-4 rounded-xl">
              <p className="text-[10px] font-mono text-violet-400 leading-relaxed uppercase">
                Note: Always include your{" "}
                <span className="text-white">Registered Gmail</span> and{" "}
          ...
          {/* REFUND POLICY */}
          {/* REFUND POLICY */}
          <div className="space-y-5 border-t border-red-500/20 pt-8">
            <span className="text-[20px] font-mono text-red-400 uppercase tracking-[0.3em]">
              Refund_Policy
            </span>

            <div className="space-y-4 text-sm font-semibold leading-relaxed">
              <div className="p-5 bg-red-500/[0.04] rounded-2xl border border-red-500/20">
              ...
              <div className="p-5 bg-red-500/[0.04] rounded-2xl border border-red-500/20">
                <p className="text-red-300">
                  •{" "}
                  <span className="text-white font-bold">
                    0–2 Hours Before Slot:
                  </span>{" "}
                  40% refund.
                </p>
              </div>

              <div className="p-5 bg-red-500/[0.08] rounded-2xl border border-red-500/40 shadow-[0_0_20px_rgba(239,68,68,0.1)]">
                <p className="text-red-400 font-bold">
                  • After Slot Time: No refund applicable.
                </p>
              </div>
            </div>
          </div>
