  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="w-full max-w-[460px] relative group">
        ...
        {/* ATMOSPHERIC GLOW - CYAN/VIOLET SHIFT */}
        ...
        <div className="relative bg-black/60 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-10 shadow-2xl">
          ...
          <div className="mb-10 text-center">
            <div className="inline-flex p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-2xl mb-4 animate-pulse">
          ...
          <div className="space-y-8">
            ...
            <div className="relative group/input">
              <input
                ...
                className="w-full bg-white/[0.03] border-2 border-white/10 rounded-2xl py-6 text-center text-3xl font-black tracking-[0.5em] text-cyan-400 placeholder:text-zinc-800 focus:outline-none focus:border-cyan-500/50 focus:ring-4 focus:ring-cyan-500/10 transition-all font-mono"
              />
              <p className="text-center mt-4 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                Enter 6-digit transmission code
              </p>
            </div>
            ...
            <div className="space-y-4">
              <button 
                ...
                className="group relative w-full h-14 bg-white text-black font-black uppercase tracking-[0.2em] text-xs rounded-2xl overflow-hidden transition-all active:scale-95 disabled:opacity-30 disabled:grayscale"
              >
